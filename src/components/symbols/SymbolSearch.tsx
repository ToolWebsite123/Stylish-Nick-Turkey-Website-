      ...
      <div className="flex flex-col sm:flex-row items-stretch sm:items-center justify-between gap-3">
        ...
        <div className="relative flex-1">
          ...
          <input
            ...
            placeholder="Sembol adı veya kelime ara... (Örn: Kalp, Yıldız, Kılıç, PUBG)"
        ...
        <div className="flex items-center justify-between sm:justify-end gap-3 px-1">
          ...
          {isFiltered && (
            <button
              ...
              className="text-xs font-medium text-rose-500 hover:text-rose-600 hover:underline flex items-center gap-1 whitespace-nowrap"
            >
